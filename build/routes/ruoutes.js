...
class Rutas {
    constructor() {
        ...
        // Calcular el numero de veces que se repite un sintoma
        this.sintomas = (req, res) => __awaiter(this, void 0, void 0, function* () {
            yield database_1.db.conectarBD()
                .then((mensaje) => __awaiter(this, void 0, void 0, function* () {
                const query = yield urgencias_1.Urgencias.aggregate([
                    {
        ...
        // Calcular el numero de consultas que han atendido los diferentes medicos
        this.consultas = (req, res) => __awaiter(this, void 0, void 0, function* () {
            yield database_1.db.conectarBD()
                .then((mensaje) => __awaiter(this, void 0, void 0, function* () {
                const query = yield urgencias_1.Urgencias.aggregate([
                    {
    ...
    misRutas() {
        ...
        this._router.get('/sintomas', this.sintomas);
        this._router.get('/consultas', this.consultas);
    }
}
const obj = new Rutas();
obj.misRutas();
